...
[![Test](https://github.com/user/event_bus/actions/workflows/test.yml/badge.svg)](https://github.com/user/event_bus/actions/workflows/test.yml)
...
```bash
git clone https://github.com/user/event_bus.git
cd event_bus
pip install -e ".[test]"
```
