# InfinityBus Documentation / 文档

Welcome! Select your language version below.
欢迎！请选择您的语言版本。
...
- **[English](en-us/event_bus.md)**
- **[中文（简体）](zh-cn/event_bus.md)**
...
| - | - | - |
| [Overview](en-us/event_bus.md) | [总览](zh-cn/event_bus.md) | Architecture & component map / 架构与组件关系 |
| [EventBus](en-us/bus.md) | [EventBus](zh-cn/bus.md) | Core bus, lifecycle, proxy, shutdown / 核心总线、生命周期、代理、停机 |
