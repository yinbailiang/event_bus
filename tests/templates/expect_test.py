...
from event_bus.templates import OneShotEventHandler, expect
...
@pytest.mark.asyncio
async def test_expect_cleans_up_handler_after_context(
    running_bus: EventBus, handler_registry: EventHandlerRegistry
) -> None:
